...
public class ChainBuffer {
    ...
    public void applyChainSwingBuffer(ModelRenderer... boxes) {
        float rotateAmount = 0.01745329251F * ClientUtils.interpolate(this.prevYawVariation, this.yawVariation, Minecraft.getMinecraft().getParticleTicks()) / boxes.length;
    ...
    public void applyChainWaveBuffer(ModelRenderer... boxes) {
        float rotateAmount = 0.01745329251F * ClientUtils.interpolate(this.prevPitchVariation, this.pitchVariation, Minecraft.getMinecraft().getParticleTicks()) / boxes.length;
        for (ModelRenderer box : boxes) {
