...
public class ClientProxy {
    ...
    public void onPostInit() {
        ...
        Map<Class<? extends Entity>, Render> map = MINECRAFT.getRenderManager().entityRenderMap;
        ...
        for (Entry<Class, TileEntitySpecialRenderer> entry : TileEntityRendererDispatcher.instance.mapSpecialRenderers.entrySet()) {
